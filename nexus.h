...
// version info
#define NEX_VERSION	"0.2"	// version string
#define NEX_EDITION	"Dave"	// edition name
...
#define NEX_PK3		"nexus.pk3"			// pk3 file (c:\path\to\et\etmain\nexus.pk3)
#define NEX_EG		"OpensourcePowa"	// custom etpro guid
#define NEX_ES		true				// enable spoofing by default
#define NEX_KS		"^0[^3NEXUS^0] ^nowned ^1>^7[n]^1< ^0| ^nSpree: ^1[c] ^0| ^nTotal: ^1[t] ^1[m]"
